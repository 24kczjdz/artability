...
export const artworks: Artwork[] = [
  {
    ...
    story:
      "Leo painted this after a rainy afternoon. He mixed every color he could find and said the rainbow was 'how happy feels in the sky.'",
  ...
  },
  {
    ...
    verifiedAsdCreator: true,
    story:
      "Maya loves the sound of waves. She layered soft teal strokes until the page felt calm enough to rest her eyes on.",
  ...
  },
  {
    ...
    verifiedAsdCreator: true,
    story:
      "Sam draws circles for everyone he cares about. Each ring is a person; the overlapping ones are family.",
  ...
  },
  {
    ...
    verifiedAsdCreator: true,
    story:
      "Ava collected fabric scraps and pressed them into paint. Her garden grew from touch first, then from color.",
  ...
  },
  {
    ...
    verifiedAsdCreator: true,
    story:
      "Noah maps routes between stars the way he maps routes between thoughts. Corporate CSR partners use this piece for calm workspace galleries.",
  ...
  },
  {
    ...
    verifiedAsdCreator: true,
    story:
      "Ellie lined up yellow squares like cookies cooling on a tray. She giggled every time she added another warm block.",
  ...
  },
  {
    ...
    verifiedAsdCreator: true,
    story:
      "Jordan spent three weeks building layers of green. The darkest trees are days that felt hard; the lightest leaves are days that felt kind.",
  ...
  },
  {
    ...
    verifiedAsdCreator: true,
    story:
      "Priya pressed her hands into paint with her dad. Each print is a hello — bright, messy, and full of trust.",
